...
class SignIn extends React.Component {
    ...
    onSubmitForm =() =>{
        fetch('https://mysterious-inlet-58186.herokuapp.com/signin', {
            method: 'post',
            ...
            <article className="br3 ba dark-gray b--black-10 mb3 mt0 w-100 w-50-m w-25-l mw6 shadow-5 center">
                <main className="pa4 black-80">
                    <div className="measure">
                        ...
                        <div className="">
                        <input  onClick={this.onSubmitForm} className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib br2" type="submit" value="Sign In"/>
                        </div>
                        {/* {this.state.error === true && <span className='error'>Incorrect email or password. Try again.</span>} */}
                        
                        <div className="lh-copy mt3">
                        <span className= 'no-underline'>Don't have an account?</span>
                        <p onClick={()=>onRouteChange('register')} className="f6 b link dim black db pointer underline ">Register</p>
                        </div>
                    </div>
                </main>
            </article>
